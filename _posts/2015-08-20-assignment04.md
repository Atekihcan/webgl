...
<div id="helpPanel" class="col-md-10 col-md-offset-1 col-xs-12 help-panel control-panel" style="margin-top: -20px">
...
<div id="lightGroup" class="col-md-3 col-sm-4 col-xs-9 text-right control-panel-group control-panel-group-right">
    ...
    <div id="lightPanel" class="control-panel" style="display: none;">
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <div class="col-md-7 col-xs-7 text-left" style="padding-right: 0px;">
                    <select id="lightSelector" onchange="selectLight(this.value)" style="width: 100%">
                        <option value="1">Point Light 1</option>
                        <option value="2">Point Light 2</option>
                        <option value="3">Point Light 3</option>
                    </select>
                </div>
                <div class="col-md-2 col-xs-2 text-center">
                    <input id="lightColUI" class="color {hash: true, required: false} color-round" value="#ffffff" onchange="setPointLightColor(this.value)" />
                </div>
                <div class="col-md-3 col-xs-3 checkBoxSlider">
                    <input type="checkbox" id="uiPointLightOn" onchange="enablePointLight(this.checked)" checked />
                    <label for="uiPointLightOn"></label>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <div class="col-md-12 col-xs-12 text-center">Position</div>
                <div class="col-md-6 col-xs-6 text-right">
                    Animate
                </div>
                <div class="col-md-6 col-xs-6 checkBoxSlider">
                    <input type="checkbox" id="uiAnimatePointLight" onchange="animatePointLight(this.checked)" checked />
                    <label for="uiAnimatePointLight"></label>
                </div>
...
<div class="row" style="margin-top: 30px;">
    <div class="col-md-12">
        ...
        <div class="canvas-info" style="margin-left: 20px">
...
<div id="othersGroup" class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1 control-panel-group-bottom">
    ...
    <div id="newObjectPanel" style="display: none;">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12 text-center control-panel-bottom">
